...
let minute = 24;
let second = 60;
let topButton = document.querySelectorAll('.topButton')
...
function timer(){
    ...
    screen.innerHTML = `${putZero(minute)}:${putZero(second)}` 
...
function setColor(backg, tes){
    for(let i = 0; i < teste.topButton; i++) topButton[i].style.background = backg;
